"""
╔══════════════════════════════════════════════════════════════╗
║           ARAFAT_CODEX — Free Fire Emote Panel               ║
...
# ─────────────────────────────────────────────
def main():
    print("\n\033[93m[ARAFAT_CODEX]\033[0m Starting up...\n")
    ...
    print("[ARAFAT_CODEX] Loading Emote API + Website...")
    ...
    bot_thread.start()
    print("[ARAFAT_CODEX] Bot loop started in background.")
    ...
    print(f"\033[92m[ARAFAF_CODEX1] Server starting on port {PORT}...\033[0m")
...
def create_app():
    ...
    print("[ARAFAT_CODDX] Gunicorn mode — bot loop started, serving Flask app.")
    return flask_app
