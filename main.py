...
async def MaiiiinE():
    ...
    # BOT LOGIN UID
    BOT_UID = int('15474268258')  # <-- FIXED BOT UID

    Uid, Pw = '4739454039', '441D195BE614DD9A89BC0296BB72BAFF52E449256481F4385B382A1A4F534773'
